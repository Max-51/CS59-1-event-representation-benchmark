...
```bash
python artifacts/classification/traditional/build_traditional_classification_report.py \
  --input-dir /path/to/downloaded/archives \
  --output-dir artifacts/classification/traditional
```
...
- CIFAR10-DVS result package for this run is stored under:
  `artifacts/classification/traditional/cifar10dvs/20260519_cifar10dvs_aligned_cls_v2_traditional/`.
