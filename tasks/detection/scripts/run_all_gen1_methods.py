...
def build_index_if_needed(args):
    ...
    command = [
        sys.executable,
        "tasks/detection/scripts/build_gen1_window_index.py",
        "--root",
        args.root,
        "--output-dir",
        args.metadata_dir,
...
def train_method(args, method):
    ...
    command = [
        sys.executable,
        "tasks/detection/scripts/train_gen1_detection.py",
        "--root",
        args.root,
        "--method",
        method,
...
def summarize(args):
    command = [
        sys.executable,
        "tasks/detection/scripts/summarize_gen1_results.py",
        "--results-root",
        args.output_dir,
        "--output",
...
def main():
    ...
    parser.add_argument("--output-dir", default="artifacts/detection/gen1/default_run")
