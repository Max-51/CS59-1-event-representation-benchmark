...
- Current result state: the corrected float64/timestamp-aligned rerun completed
  ...
  `artifacts/optical_flow/mvsec/20260516_float64_cached/` (legacy local links
  in this folder are kept for compatibility).
...
- `artifacts/optical_flow/mvsec/20260516_float64_cached/results/summary_all/mvsec_e100_earlystop_summary.md`
- `artifacts/optical_flow/mvsec/20260516_float64_cached/results/summary_learning/mvsec_e100_earlystop_summary.md`
- `artifacts/optical_flow/mvsec/20260516_float64_cached/results/summary_traditional/mvsec_e100_earlystop_summary.md`
